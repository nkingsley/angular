...
export function renderTemplate<T>(
  ...
  if (componentView === null) {
    ...
    const hostTNode =
        getOrCreateTNode(hostLView[TVIEW], hostLView[T_HOST], 0, TNodeType.Element, null, null);
